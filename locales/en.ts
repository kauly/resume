export default {
  ...
  jobTitle: "job title",
  date: "date",
  aboutMeTextFirst: `I have been interested in coding for many years and I completed my first coding qualification more than 10 years ago. Although I have had a variety of jobs in the past, coding has always been my passion. Finally six years ago I was able to pursue coding on a fulltime basis and I started coding professionally. It's been so rewarding, I started as an intern and made my way up in the ranks quickly after that. The journey brings me opportunities to work with amazing people and make products used by hundreds of people worldwide. I am very grateful for that.`,
  aboutMeTextSecond: `I have been working as a full-stack developer, focusing on the JS world and all the cool things it brings to the table. I am always learning new things and am very excited to work with new technologies. Lately, I've been delving into AI, particularly NLP and LLMs, to improve user interactions with web applications. You will find a reliable coworker in me, always willing to help and learn from others, documenting my progress, and remaining realistic about deadlines and features. I hope you enjoyed reading this. Please feel free to contact me.`,
